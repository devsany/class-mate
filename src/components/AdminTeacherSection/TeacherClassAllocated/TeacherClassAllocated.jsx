              ...
              <tr key={teacher.teacher_id} className="hover:bg-gray-100">
                ...
                <td className="p-4 border-b">
                  {teacher.experience.map((exp, index) => (
                    <div key={index}>
                      <li>
                        {exp.position} <b>at</b> {exp.school} ({exp.start_date}{" "}
                        <b>to</b> {exp.end_date})
                      </li>
                    </div>
                  ))}
                ...
                <td className="p-4 border-b">
                  <NavLink
                    to={`/teacher-class-Allocated/${teacher.teacher_id}`}
...
export default TeacherClassAllocated;
